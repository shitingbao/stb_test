...
type Data_Redis struct {
	...
	PostTokenTimeout *durationpb.Duration   `protobuf:"bytes,7,opt,name=post_token_timeout,json=postTokenTimeout,proto3" json:"post_token_timeout,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *Data_Redis) GetPostTokenTimeout() *durationpb.Duration {
	if x != nil {
		return x.PostTokenTimeout
	}
	return nil
}
...
const file_conf_proto_rawDesc = "" +
	...
	"\rwrite_timeout\x18\x06 \x01(\v2\x19.google.protobuf.DurationR\fwriteTimeout\x12G\n" +
	"\x12post_token_timeout\x18\a \x01(\v2\x19.google.protobuf.DurationR\x10postTokenTimeoutB\x1bZ\x19common/internal/conf;confb\x06proto3"
...
var file_conf_proto_depIdxs = []int32{
	...
	7,  // 11: kratos.api.Data.Redis.post_token_timeout:type_name -> google.protobuf.Duration
